...
- navigation:
  - compute_distance between lat lon points function
  - compute_distances between lat lon points (vectors)
  - cumulative_distances of lat lon vectors
