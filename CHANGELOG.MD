...
- EchoProxy class to pingprocessing
- echosounders: simradraw ek80 corrected power computation from complex32 floats
...
- update pybind11 2.12.0 -> 2.13.5
- update Catch2 3.6.0 -> 3.7.0
