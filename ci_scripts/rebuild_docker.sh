...
docker build docker-ubuntu -t ghcr.io/themachinethatgoesping/ubuntu-dep
docker push ghcr.io/themachinethatgoesping/ubuntu-dep

docker build docker-manylinux_x86_64 -t ghcr.io/themachinethatgoesping/manylinux_x86_64-dep
