...
def plot_bs_comparison(frequency_hz: float = 300000.0, water_depth_m: float = 50.0, bubble_diameter_min_mm: float = 0.001, bubble_diameter_max_mm: float = 20.0, num_points: int = 50000, ax: Union[matplotlib.axes._axes.Axes, None] = None) -> matplotlib.axes._axes.Axes:
    """
