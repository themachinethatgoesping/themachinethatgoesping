...
class PUIDOutput(EM3000Datagram):
    ...
    def get_has_shallow_water_sonar_head(self) -> bool: 
        ...
        """
    def get_host_ip_address(self) -> typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(4)]: ...
    ...
    def get_spare(self) -> typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(7)]: ...
    ...
    def set_etx(self, arg0: int) -> None: 
        ...
        < end identifier (always 0x03)
        """
    def set_host_ip_address(self, arg0: typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(4)]) -> None: ...
    ...
    def set_spare(self, arg0: typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(7)]) -> None: ...
...
class QualityFactorDatagram(EM3000Datagram):
    ...
    def print(self, float_precision: int = 2) -> None: 
        ...
        Print object information
        """
    def qf_shape(self) -> typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(2)]: 
        """
...
class WatercolumnDatagram(EM3000Datagram):
    ...
    def get_sound_speed_m_s(self) -> float: 
        ...
        """
    def get_spare(self) -> typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(3)]: ...
    def get_system_serial_number(self) -> int: ...
    ...
    def set_sound_speed(self, arg0: int) -> None: 
        ...
        < in 0.1 m/s
        """
    def set_spare(self, arg0: typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None: ...
    def set_system_serial_number(self, arg0: int) -> None: ...
...
class XYZDatagram(EM3000Datagram):
    ...
    def get_sound_speed_in_m_per_s(self) -> float: 
        ...
        """
    def get_spare_byte(self) -> int: ...
    def get_spare_bytes(self) -> typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(3)]: ...
    def get_system_serial_number(self) -> int: 
        """
        < 100 -
        """
    ...
    def set_sound_speed(self, arg0: int) -> None: 
        ...
        """
    def set_spare_byte(self, arg0: int) -> None: ...
    def set_spare_bytes(self, arg0: typing.Annotated[typing.List[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None: ...
    def set_system_serial_number(self, arg0: int) -> None: 
        """
        < 100 -
        """
