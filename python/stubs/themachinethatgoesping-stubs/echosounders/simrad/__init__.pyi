...
class FileRaw():
    ...
    def __getitem__(self, index: int) -> typing.Union[datagrams.EK60_Datagram, datagrams.EK80_MRU0, datagrams.EK80_XML0, datagrams.EK60_NME0, datagrams.EK80_TAG0, datagrams.EK60_Unknown]: ...
    @typing.overload
...
class FileRawIterator_TAG0():
    ...
    def __getitem__(self, index: int) -> datagrams.EK80_TAG0: ...
    def __len__(self) -> int: ...
    def size(self) -> int: ...
    pass
