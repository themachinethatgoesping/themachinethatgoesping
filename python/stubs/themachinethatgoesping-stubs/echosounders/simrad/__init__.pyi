...
class SimradPing():
    @staticmethod
    def file_data(*args, **kwargs) -> typing.Any: ...
...
class SimradPing_RawData():
    ...
    def release_data(self) -> None: ...
    @property
    def file_data(self) -> themachinethatgoesping::echosounders::simrad::SimradFileData:
        """
        :type: themachinethatgoesping::echosounders::simrad::SimradFileData
        """
    @property
