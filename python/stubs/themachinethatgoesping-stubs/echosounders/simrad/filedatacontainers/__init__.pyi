...
__all__ = [
    ...
    "SimradRawDatagramContainer_RAW3_skipped_data_mapped",
    ...
    "SimradRawDatagramContainer_Variant_skipped_data",
    "SimradRawDatagramContainer_Variant_skipped_data_mapped",
...
class SimradRawDatagramContainer_RAW3_skipped_data():
    ...
    @typing.overload
    def __call__(self, datagram_identifiers: typing.List[themachinethatgoesping.echosounders.simrad.t_SimradDatagramIdentifier]) -> SimradRawDatagramContainer_RAW3_skipped_data: ...
    ...
    def __str__(self) -> str: 
        ...
        Return object information as string
        """
    def break_by_time_diff(self, max_time_diff_seconds: float) -> typing.List[SimradRawDatagramContainer_RAW3_skipped_data]: 
        """
        Split the data if the time difference between two subsequent datagrams
        is larger than arg Note: for this function to make sense the data
        should be sorted_in_time
...
class SimradRawDatagramContainer_RAW3_skipped_data_mapped():
    ...
    @typing.overload
    def __call__(self, datagram_identifiers: typing.List[themachinethatgoesping.echosounders.simrad.t_SimradDatagramIdentifier]) -> SimradRawDatagramContainer_RAW3_skipped_data_mapped: ...
    ...
    def __str__(self) -> str: 
        ...
        Return object information as string
        """
    def break_by_time_diff(self, max_time_diff_seconds: float) -> typing.List[SimradRawDatagramContainer_RAW3_skipped_data_mapped]: 
        """
        Split the data if the time difference between two subsequent datagrams
        is larger than arg Note: for this function to make sense the data
        should be sorted_in_time
...
class SimradRawDatagramContainer_Variant_skipped_data():
    ...
    @typing.overload
    def __call__(self, datagram_identifiers: typing.List[themachinethatgoesping.echosounders.simrad.t_SimradDatagramIdentifier]) -> SimradRawDatagramContainer_Variant_skipped_data: ...
    ...
    def __str__(self) -> str: 
        ...
        Return object information as string
        """
    def break_by_time_diff(self, max_time_diff_seconds: float) -> typing.List[SimradRawDatagramContainer_Variant_skipped_data]: 
        """
        Split the data if the time difference between two subsequent datagrams
        is larger than arg Note: for this function to make sense the data
        should be sorted_in_time
...
class SimradRawDatagramContainer_Variant_skipped_data_mapped():
    ...
    @typing.overload
    def __call__(self, datagram_identifiers: typing.List[themachinethatgoesping.echosounders.simrad.t_SimradDatagramIdentifier]) -> SimradRawDatagramContainer_Variant_skipped_data_mapped: ...
    ...
    def __str__(self) -> str: 
        ...
        Return object information as string
        """
    def break_by_time_diff(self, max_time_diff_seconds: float) -> typing.List[SimradRawDatagramContainer_Variant_skipped_data_mapped]: 
        """
        Split the data if the time difference between two subsequent datagrams
        is larger than arg Note: for this function to make sense the data
        should be sorted_in_time
