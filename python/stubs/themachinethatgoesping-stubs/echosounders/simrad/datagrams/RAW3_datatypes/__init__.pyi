...
class i_RAW3_Data():
    ...
    @staticmethod
    def get_angle_across(*args, **kwargs) -> typing.Any: ...
    @staticmethod
    def get_angle_along(*args, **kwargs) -> typing.Any: ...
...
class RAW3_DataComplexFloat32(i_RAW3_Data):
    ...
    def copy(self) -> RAW3_DataComplexFloat32: 
        ...
        """
    def get_angle(self) -> numpy.ndarray[numpy.uint8]: ...
    def get_angle_across(self) -> numpy.ndarray[numpy.uint8]: ...
    def get_angle_along(self) -> numpy.ndarray[numpy.uint8]: ...
