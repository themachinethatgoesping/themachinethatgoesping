...
class JupyterControlHandle(themachinethatgoesping.pingprocessing.widgets.control_spec.ControlHandle):
...
class JupyterControlPanel(themachinethatgoesping.pingprocessing.widgets.control_spec.ControlPanel):
    """
