...
class ResolvedBand:
    ...
    def __init__(self, cs, i0: numpy.ndarray, i1: numpy.ndarray): ...

    @property
    def y0(self) -> numpy.ndarray: ...

    @property
    def y1(self) -> numpy.ndarray: ...

    def bounds(self, reference: str) -> Tuple[numpy.ndarray, numpy.ndarray]:
...
class LayerStore:
    ...
    def sample_indices(self, name: str) -> Tuple[numpy.ndarray, numpy.ndarray]: ...

    def grid_indices(self, name: str) -> Tuple[numpy.ndarray, numpy.ndarray]: ...

    def bounds(self, name: str, reference: str) -> Tuple[numpy.ndarray, numpy.ndarray]: ...
