...
class ImageBackend(themachinethatgoesping.pingprocessing.watercolumn.echograms.backends.base.EchogramDataBackend):
    ...
    def __init__(self, image: numpy.ndarray, ping_times: numpy.ndarray, y_min: numpy.ndarray, y_max: numpy.ndarray, *, y_axis: str = 'range', wci_value: str = 'sv', linear_mean: bool = True, latitudes: Optional[numpy.ndarray] = None, longitudes: Optional[numpy.ndarray] = None, ping_params: Optional[Dict[str, Tuple[str, Tuple[numpy.ndarray, numpy.ndarray]]]] = None):
        """
    ...
    @classmethod
    def from_image(cls, image: numpy.ndarray, ping_times: numpy.ndarray, y_min: Union[float, numpy.ndarray], y_max: Union[float, numpy.ndarray], *, y_axis: str = 'range', wci_value: str = 'sv', linear_mean: bool = True, latitudes: Optional[numpy.ndarray] = None, longitudes: Optional[numpy.ndarray] = None, ping_params: Optional[Dict] = None) -> 'ImageBackend':
        """
    ...
    @classmethod
    def from_mmap(cls, path: Union[str, Path], ping_times: numpy.ndarray, y_min: Union[float, numpy.ndarray], y_max: Union[float, numpy.ndarray], *, shape: Optional[Tuple[int, int]] = None, dtype: numpy.dtype = numpy.float32, y_axis: str = 'range', wci_value: str = 'sv', linear_mean: bool = True, latitudes: Optional[numpy.ndarray] = None, longitudes: Optional[numpy.ndarray] = None, ping_params: Optional[Dict] = None) -> 'ImageBackend':
        """
    ...
    @property
    def range_extents(self) -> Optional[Tuple[numpy.ndarray, numpy.ndarray]]: ...

    @property
    def depth_extents(self) -> Optional[Tuple[numpy.ndarray, numpy.ndarray]]: ...

    @property
    def has_navigation(self) -> bool: ...

    @property
    def latitudes(self) -> Optional[numpy.ndarray]: ...

    @property
    def longitudes(self) -> Optional[numpy.ndarray]: ...
