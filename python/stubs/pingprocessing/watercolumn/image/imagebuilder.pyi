...
class ImageBuilder:
    def __init__(self, pings, horizontal_pixels, wci_render='linear', progress=False, oversampling=1, oversampling_mode='linear_mean', max_cache_images=200, **kwargs): ...

    def clear_cache(self):
        """Drop all cached sub-images."""

    def update_args(self, wci_render='linear', oversampling=None, oversampling_mode=None, max_cache_images=None, **kwargs): ...
