...
class SimradRawWaterColumnCalibration(themachinethatgoesping.echosounders_nanopy.filetemplates.WaterColumnCalibration):
    ...
    @overload
    def set_filter_parameters(self, stage1_decimation_factor: int, stage1_coefficients: Annotated[NDArray[numpy.complex64], dict(shape=(None,), order='A')], stage2_decimation_factor: int, stage2_coefficients: Annotated[NDArray[numpy.complex64], dict(shape=(None,), order='A')]) -> None: ...
    ...
    def get_filter_stage_1_coefficients(self) -> Annotated[NDArray[numpy.complex64], dict(shape=(None,), order='C')]: ...

    def get_filter_stage_2_coefficients(self) -> Annotated[NDArray[numpy.complex64], dict(shape=(None,), order='C')]: ...
