...
class RAW3DataComplexFloat32(i_RAW3Data):
    ...
    @overload
    def __init__(self, complex_samples: Annotated[NDArray[numpy.float32], dict(order='C')]) -> None: ...

    def __eq__(self, other: RAW3DataComplexFloat32) -> bool: ...

    def get_complex_samples_bfloat16(self, max_samples: int) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_power(self, dB: bool = False) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_coherent_sum(self, dB: bool = False) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_incoherent_sum(self, dB: bool = False) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_angle(self) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_power_xtensor(self, dB: bool = False) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_incoherent_sum_xtensor(self, dB: bool = False) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    @property
    def complex_samples(self) -> Annotated[NDArray[numpy.float32], dict(order='C')]:
        """Sample data"""

    @complex_samples.setter
    def complex_samples(self, arg: Annotated[NDArray[numpy.float32], dict(order='C')], /) -> None: ...
...
class RAW3DataPowerAndAngle(i_RAW3Data):
    ...
    @overload
    def __init__(self, power: Annotated[NDArray[numpy.int16], dict(order='C')], angle: Annotated[NDArray[numpy.uint8], dict(order='C')]) -> None: ...
    ...
    @property
    def power(self) -> Annotated[NDArray[numpy.int16], dict(order='C')]:
        """Sample data"""

    @power.setter
    def power(self, arg: Annotated[NDArray[numpy.int16], dict(order='C')], /) -> None: ...

    @property
    def angle(self) -> Annotated[NDArray[numpy.int8], dict(order='C')]:
        """[along, athwart] 180/128 electrical degrees"""

    @angle.setter
    def angle(self, arg: Annotated[NDArray[numpy.int8], dict(order='C')], /) -> None: ...
...
class RAW3DataPower(i_RAW3Data):
    ...
    @overload
    def __init__(self, power_and_angle: Annotated[NDArray[numpy.int16], dict(order='C')]) -> None: ...
...
class RAW3DataAngle(i_RAW3Data):
    ...
    @overload
    def __init__(self, angle: Annotated[NDArray[numpy.uint8], dict(order='C')]) -> None: ...
