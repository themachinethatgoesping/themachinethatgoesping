...
class AmplitudeCalibration:
    ...
    def get_per_beam_offsets(self, beamangles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')]) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')]: ...
    ...
    def set_offset_per_beamangle(self, beamangle: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], offset: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')]) -> None: ...

    def has_offset_per_beamangle(self) -> bool: ...

    def set_offset_per_range(self, range: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], offset: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')]) -> None: ...

    def has_offset_per_range(self) -> bool: ...

    @overload
    def set_offset_per_beamangle_and_range(self, beamangles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], values: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]) -> None: ...
...
class WaterColumnCalibration:
    ...
    @overload
    def apply_beam_sample_correction_power(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_power(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_rp(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_rp(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_rv(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_rv(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_pp(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_pp(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_pv(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_pv(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_ap(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_ap(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_av(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_av(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_sv(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_sv(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_sp(self, wci: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='A')]: ...

    @overload
    def apply_beam_sample_correction_sp(self, wci: Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')], beam_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], ranges: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], mp_cores: int = 1) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='A')]: ...
...
class I_PingBottom(I_PingCommon):
    ...
    @overload
    def get_tx_sector_per_beam(self) -> Annotated[NDArray[numpy.uint64], dict(shape=(None,), order='C')]: ...

    @overload
    def get_tx_sector_per_beam(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> Annotated[NDArray[numpy.uint64], dict(shape=(None,), order='C')]: ...
    ...
    @overload
    def get_beam_crosstrack_angles(self) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_beam_crosstrack_angles(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...
    ...
    @overload
    def get_two_way_travel_times(self) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_two_way_travel_times(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...
...
class I_PingWatercolumn(I_PingCommon):
    ...
    @overload
    def get_beam_alongtrack_angles(self) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_beam_alongtrack_angles(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...

    def get_beam_sample_selection_all(self) -> themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection: ...

    def get_first_sample_offset_per_beam(self) -> Annotated[NDArray[numpy.uint32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_number_of_samples_per_beam(self) -> Annotated[NDArray[numpy.uint32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_number_of_samples_per_beam(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> Annotated[NDArray[numpy.uint32], dict(shape=(None,), order='C')]: ...
    ...
    @overload
    def get_approximate_ranges(self) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_approximate_ranges(self, beam_sample_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), order='C')]: ...
    ...
    @overload
    def get_amplitudes(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_amplitudes(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_rp(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_rp(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_rv(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_rv(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_pp(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_pp(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_pv(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_pv(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_ap(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_ap(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_av(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_av(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_power(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_power(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_sp(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_sp(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_sv(self, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_sv(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    def has_bottom_range_samples(self) -> bool: ...

    @overload
    def get_bottom_range_samples(self) -> Annotated[NDArray[numpy.uint32], dict(shape=(None,), order='C')]: ...

    @overload
    def get_bottom_range_samples(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> Annotated[NDArray[numpy.uint32], dict(shape=(None,), order='C')]: ...
    ...
    @overload
    def get_wci_correction(self, calibration_type: o_calibration_type, calibration_base: o_calibration_type = t_calibration_type.power, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_wci_correction(self, beam_sample_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, calibration_type: o_calibration_type, calibration_base: o_calibration_type = t_calibration_type.power, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_wci(self, calibration_type: o_calibration_type, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...

    @overload
    def get_wci(self, beam_sample_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection, calibration_type: o_calibration_type, mp_cores: int = 1) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='C')]: ...
