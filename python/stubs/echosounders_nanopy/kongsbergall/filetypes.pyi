...
import themachinethatgoesping.algorithms_nanopy.geoprocessing.raytracers2
...
class KongsbergAllWaterColumnCalibration(themachinethatgoesping.echosounders_nanopy.filetemplates.WaterColumnCalibration):
    ...
    def get_av_calibration_old(self) -> float: ...
...
class KongsbergAllPingFileData_stream(themachinethatgoesping.echosounders_nanopy.filetemplates.I_PingFileData):
    ...
    def has_soundspeed_profile(self) -> bool: ...

    def set_soundspeed_profile(self, soundspeed_profile: "boost::flyweights::flyweight_themachinethatgoesping_echosounders_kongsbergall_datagrams_SoundSpeedProfileDatagram_boost_parameter_void__boost_parameter_void__boost_parameter_void__boost_parameter_void__boost_parameter_void_") -> None: ...

    def get_soundspeed_profile(self) -> themachinethatgoesping.echosounders_nanopy.kongsbergall.datagrams.SoundSpeedProfileDatagram: ...

    def has_sound_speed_profile_datagram(self) -> bool: ...

    def get_sound_speed_profile_datagram(self) -> themachinethatgoesping.echosounders_nanopy.kongsbergall.datagrams.SoundSpeedProfileDatagram: ...

    def has_sound_speed_profile(self) -> bool: ...

    def set_sound_speed_profile(self, sound_speed_profile: "boost::flyweights::flyweight_themachinethatgoesping_algorithms_geoprocessing_raytracers2_SoundVelocityProfile_boost_parameter_void__boost_parameter_void__boost_parameter_void__boost_parameter_void__boost_parameter_void_") -> None: ...

    def get_sound_speed_profile(self) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.raytracers2.SoundVelocityProfile: ...
