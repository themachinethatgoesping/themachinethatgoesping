...
class ExtraDetections(KongsbergAllDatagram):
    ...
    @property
    def detection_classes(self) -> substructures.ExtraDetectionsDetectionClassesContainer:
        """substructure 1"""

    @detection_classes.setter
    def detection_classes(self, arg: substructures.ExtraDetectionsDetectionClassesContainer, /) -> None: ...

    @property
    def extra_detections(self) -> substructures.ExtraDetectionsExtraDetectionsContainer:
        """substructure 2"""

    @extra_detections.setter
    def extra_detections(self, arg: substructures.ExtraDetectionsExtraDetectionsContainer, /) -> None: ...
...
class RawRangeAndAngle(KongsbergAllDatagram):
    ...
    @property
    def transmit_sectors(self) -> substructures.RawRangeAndAngleTransmitSectorsContainer: ...

    @transmit_sectors.setter
    def transmit_sectors(self, arg: substructures.RawRangeAndAngleTransmitSectorsContainer, /) -> None: ...

    @property
    def beams(self) -> substructures.RawRangeAndAngleBeamsContainer: ...

    @beams.setter
    def beams(self, arg: substructures.RawRangeAndAngleBeamsContainer, /) -> None: ...
...
class SeabedImageData(KongsbergAllDatagram):
    ...
    @property
    def beams(self) -> substructures.SeabedImageDataBeamsContainer: ...

    @beams.setter
    def beams(self, arg: substructures.SeabedImageDataBeamsContainer, /) -> None: ...
...
class WatercolumnDatagram(KongsbergAllDatagram):
    ...
    @property
    def beams(self) -> substructures.WatercolumnDatagramBeamsContainer: ...

    @beams.setter
    def beams(self, arg: substructures.WatercolumnDatagramBeamsContainer, /) -> None: ...

    @property
    def transmit_sectors(self) -> substructures.WatercolumnDatagramTransmitSectorsContainer: ...

    @transmit_sectors.setter
    def transmit_sectors(self, arg: substructures.WatercolumnDatagramTransmitSectorsContainer, /) -> None: ...
...
class AttitudeDatagram(KongsbergAllDatagram):
    ...
    def get_attitudes(self) -> substructures.AttitudeDatagramAttitudesContainer:
        """N x Attitude data"""
...
class RuntimeParameters(KongsbergAllDatagram):
    ...
    def get_frequency_mode_in_hertz(self) -> float:
        """
        Get the frequency mode in hertz object For EM2040 and EM2040C, the
...
class o_ExtraParameters_t_ContentIdentifier:
    ...
    __default_value__: Final[ExtraParameters_t_ContentIdentifier] = ...
