...
class o_XYZDatagramBeam_t_DetectionType:
    ...
    __default_value__: Final[XYZDatagramBeam_t_DetectionType] = ...
...
class ExtraDetectionsDetectionClassesContainer:
    ...
    @property
    def detection_classes(self) -> list[ExtraDetectionsDetectionClasses]: ...

    @detection_classes.setter
    def detection_classes(self, arg: Sequence[ExtraDetectionsDetectionClasses], /) -> None: ...

    def get_detection_classes(self) -> list[ExtraDetectionsDetectionClasses]: ...

    def set_detection_classes(self, detection_classes: Sequence[ExtraDetectionsDetectionClasses]) -> None: ...

    def get_start_depth_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_stop_depth_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_qf_threshold_100_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_bs_threshold_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_snr_threshold_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_alarm_threshold_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_number_of_extra_detections_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_show_class_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_alarm_flag_1_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_qf_threshold_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_number_of_detection_classes(self) -> int: ...

    def __eq__(self, other: ExtraDetectionsDetectionClassesContainer) -> bool: ...

    def copy(self) -> ExtraDetectionsDetectionClassesContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> ExtraDetectionsDetectionClassesContainer: ...

    def __deepcopy__(self, arg: dict, /) -> ExtraDetectionsDetectionClassesContainer: ...
...
class ExtraDetectionsExtraDetectionsContainer:
    ...
    @property
    def extra_detections(self) -> list[ExtraDetectionsExtraDetections]: ...

    @extra_detections.setter
    def extra_detections(self, arg: Sequence[ExtraDetectionsExtraDetections], /) -> None: ...

    def get_extra_detections(self) -> list[ExtraDetectionsExtraDetections]: ...

    def set_extra_detections(self, extra_detections: Sequence[ExtraDetectionsExtraDetections]) -> None: ...

    def get_depth_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_across_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_along_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_delta_latitude_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_delta_longitude_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_beam_crosstrack_angle_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_applied_pointing_angle_correction_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_two_way_travel_time_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_applied_two_way_travel_time_corrections_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_backscatter_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_beam_incidence_angle_adjustment_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.int8], dict(order='C')]: ...

    def get_detection_info_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_spare_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_tx_sector_number_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_detection_window_length_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_quality_factor_old_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_real_time_cleaning_info_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_range_factor_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_detection_class_number_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_confidence_level_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_qf_10_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_water_column_beam_number_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_beam_angle_across_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_detected_range_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_number_of_raw_amplitude_samples_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_qf_threshold_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_backscatter_in_db_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_detection_is_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_type_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_backscatter_is_compensated_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_number_of_extra_detections(self) -> int: ...

    def __eq__(self, other: ExtraDetectionsExtraDetectionsContainer) -> bool: ...

    def copy(self) -> ExtraDetectionsExtraDetectionsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> ExtraDetectionsExtraDetectionsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> ExtraDetectionsExtraDetectionsContainer: ...
...
class RawRangeAndAngleTransmitSector:
    ...
    def get_tx_array_index(self) -> int:
        """
        Physical TX array index of this transmit sector (Kongsberg "Transmit
...
class RawRangeAndAngleTransmitSectorsContainer:
    ...
    @property
    def transmit_sectors(self) -> list[RawRangeAndAngleTransmitSector]: ...

    @transmit_sectors.setter
    def transmit_sectors(self, arg: Sequence[RawRangeAndAngleTransmitSector], /) -> None: ...

    def get_transmit_sectors(self) -> list[RawRangeAndAngleTransmitSector]: ...

    def set_transmit_sectors(self, sectors: Sequence[RawRangeAndAngleTransmitSector]) -> None: ...

    def get_tilt_angle_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_focus_range_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_signal_length_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_sector_transmit_delay_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_center_frequency_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_mean_absorption_coefficient_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_signal_waveform_identifier_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_transmit_sector_number_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_tx_array_index_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_signal_bandwidth_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tilt_angle_in_degrees_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_focus_range_in_m_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_mean_absorption_coefficient_in_dB_per_m_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tx_signal_type_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_number_of_transmit_sectors(self) -> int: ...

    def __eq__(self, other: RawRangeAndAngleTransmitSectorsContainer) -> bool: ...

    def copy(self) -> RawRangeAndAngleTransmitSectorsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> RawRangeAndAngleTransmitSectorsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> RawRangeAndAngleTransmitSectorsContainer: ...
...
class RawRangeAndAngleBeamsContainer:
    ...
    @property
    def beams(self) -> list[RawRangeAndAngleBeam]: ...

    @beams.setter
    def beams(self, arg: Sequence[RawRangeAndAngleBeam], /) -> None: ...

    def get_beams(self) -> list[RawRangeAndAngleBeam]: ...

    def set_beams(self, beams: Sequence[RawRangeAndAngleBeam]) -> None: ...

    def get_beam_crosstrack_angle_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_transmit_sector_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_info_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_window_length_in_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_quality_factor_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_d_corr_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int8], dict(order='C')]: ...

    def get_two_way_travel_time_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_reflectivity_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_realtime_cleaning_info_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int8], dict(order='C')]: ...

    def get_spare_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_beam_crosstrack_angle_in_degrees_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_reflectivity_in_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...
    ...
    def __eq__(self, other: RawRangeAndAngleBeamsContainer) -> bool: ...

    def copy(self) -> RawRangeAndAngleBeamsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> RawRangeAndAngleBeamsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> RawRangeAndAngleBeamsContainer: ...
...
class SeabedImageDataBeamsContainer:
    ...
    @property
    def beams(self) -> list[SeabedImageDataBeam]: ...

    @beams.setter
    def beams(self, arg: Sequence[SeabedImageDataBeam], /) -> None: ...

    def get_beams(self) -> list[SeabedImageDataBeam]: ...

    def set_beams(self, beams: Sequence[SeabedImageDataBeam]) -> None: ...

    def get_sorting_direction_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int8], dict(order='C')]: ...

    def get_detection_info_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_number_of_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_centre_sample_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...
    ...
    def __eq__(self, other: SeabedImageDataBeamsContainer) -> bool: ...

    def copy(self) -> SeabedImageDataBeamsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> SeabedImageDataBeamsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> SeabedImageDataBeamsContainer: ...
...
class WatercolumnDatagramTransmitSectorsContainer:
    ...
    @property
    def transmit_sectors(self) -> list[WatercolumnDatagramTransmitSector]: ...

    @transmit_sectors.setter
    def transmit_sectors(self, arg: Sequence[WatercolumnDatagramTransmitSector], /) -> None: ...

    def get_transmit_sectors(self) -> list[WatercolumnDatagramTransmitSector]: ...

    def set_transmit_sectors(self, transmit_sectors: Sequence[WatercolumnDatagramTransmitSector]) -> None: ...

    def get_tilt_angle_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_center_frequency_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_transmit_sector_number_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_spare_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_tilt_angle_in_degrees_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_center_frequency_in_hz_tensor(self, sector_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_number_of_transmit_sectors(self) -> int: ...

    def __eq__(self, other: WatercolumnDatagramTransmitSectorsContainer) -> bool: ...

    def copy(self) -> WatercolumnDatagramTransmitSectorsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> WatercolumnDatagramTransmitSectorsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> WatercolumnDatagramTransmitSectorsContainer: ...
...
class WatercolumnDatagramBeamsContainer:
    ...
    @property
    def beams(self) -> list[WatercolumnDatagramBeam]: ...

    @beams.setter
    def beams(self, arg: Sequence[WatercolumnDatagramBeam], /) -> None: ...

    def get_beams(self) -> list[WatercolumnDatagramBeam]: ...

    def set_beams(self, beams: Sequence[WatercolumnDatagramBeam]) -> None: ...

    def get_beam_crosstrack_angle_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_start_range_sample_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_number_of_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_detected_range_in_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_transmit_sector_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_beam_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_beam_crosstrack_angle_in_degrees_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_number_of_beams(self) -> int: ...

    def __eq__(self, other: WatercolumnDatagramBeamsContainer) -> bool: ...

    def copy(self) -> WatercolumnDatagramBeamsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> WatercolumnDatagramBeamsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> WatercolumnDatagramBeamsContainer: ...
...
class AttitudeDatagramAttitudesContainer:
    ...
    def get_indices_sorted_by_time(self, indices: Sequence[int] = []) -> list[int]: ...
...
class NetworkAttitudeVelocityDatagramAttitudesContainer:
    ...
    @property
    def attitudes(self) -> list[NetworkAttitudeVelocityDatagramAttitude]: ...

    @attitudes.setter
    def attitudes(self, arg: Sequence[NetworkAttitudeVelocityDatagramAttitude], /) -> None: ...

    def get_attitudes(self) -> list[NetworkAttitudeVelocityDatagramAttitude]: ...

    def set_attitudes(self, attitudes: Sequence[NetworkAttitudeVelocityDatagramAttitude]) -> None: ...
    ...
    def get_number_of_bytes_in_input_datagram_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...
    ...
    def __eq__(self, other: NetworkAttitudeVelocityDatagramAttitudesContainer) -> bool: ...

    def copy(self) -> NetworkAttitudeVelocityDatagramAttitudesContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> NetworkAttitudeVelocityDatagramAttitudesContainer: ...

    def __deepcopy__(self, arg: dict, /) -> NetworkAttitudeVelocityDatagramAttitudesContainer: ...
