...
class KMALLDatagramDataInterface_stream:
    ...
    @overload
    def init_from_file(self, index_paths: Mapping[str, str] = {}, force: bool = False, show_progress: bool = True) -> None: ...

    @overload
    def init_from_file(self, index_paths: Mapping[str, str], force: bool, progress_bar: themachinethatgoesping.tools_nanopy.progressbars.I_ProgressBar, external_progress_tick: bool = False) -> None: ...
