...
class MRZExtraDetClassInfoContainer:
    ...
    def get_extra_det_class_info(self) -> list[MRZExtraDetClassInfo]: ...

    def set_extra_det_class_info(self, extra_det_class_info: Sequence[MRZExtraDetClassInfo]) -> None: ...

    def get_num_extra_det_in_class_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_padding_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.int8], dict(order='C')]: ...

    def get_alarm_flag_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_number_of_extra_det_class_info(self) -> int: ...

    def __eq__(self, other: MRZExtraDetClassInfoContainer) -> bool: ...

    def copy(self) -> MRZExtraDetClassInfoContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> MRZExtraDetClassInfoContainer: ...

    def __deepcopy__(self, arg: dict, /) -> MRZExtraDetClassInfoContainer: ...
...
class MRZSoundingsContainer:
    ...
    def get_sounding_index_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_tx_sector_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_type_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_method_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_rejection_info_1_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_rejection_info_2_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_post_processing_info_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_class_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_detection_confidence_level_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_padding_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_range_factor_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_quality_factor_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_detection_uncertainty_ver_m_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_detection_uncertainty_hor_m_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_detection_window_length_sec_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_echo_length_sec_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_wc_beam_number_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_wc_range_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_wc_nom_beam_angle_across_deg_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_mean_abs_coeff_db_per_km_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_reflectivity_1_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_reflectivity_2_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_receiver_sensitivity_applied_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_source_level_applied_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_bs_calibration_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tvg_db_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_beam_angle_re_rx_deg_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_beam_angle_correction_deg_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_two_way_travel_time_sec_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_two_way_travel_time_correction_sec_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_delta_latitude_deg_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_delta_longitude_deg_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_z_re_ref_point_m_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_y_re_ref_point_m_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_x_re_ref_point_m_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_beam_inc_angle_adj_deg_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...
    ...
    def get_real_time_clean_info_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_si_start_range_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_si_centre_sample_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_si_num_samples_tensor(self, beam_numbers: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_number_of_soundings(self) -> int: ...

    def get_number_of_seabed_image_samples(self) -> int: ...

    def get_seabed_image_sounding_index_tensor(self) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_mean_absorption_db_per_m_per_sector(self, number_of_tx_sectors: int) -> Annotated[NDArray[numpy.float32], dict(order='C')]:
        """
...
class MRZTxSectorsContainer:
    ...
    def get_tx_sectors(self) -> list[MRZSectorInfo]: ...

    def set_tx_sectors(self, tx_sectors: Sequence[MRZSectorInfo]) -> None: ...

    def get_tx_sector_number_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_tx_arrary_number_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_tx_sub_array_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_padding_0_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_sector_transmit_delay_sec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tilt_angle_re_tx_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tx_nominal_source_level_db_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tx_focus_range_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_centre_frequency_hz_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_signal_band_width_hz_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_total_signal_length_sec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_pulse_shading_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_signal_wave_form_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_padding_1_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_high_voltage_level_db_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_sector_tracking_corr_db_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_effective_signal_length_sec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tx_signal_type_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_number_of_tx_sectors(self) -> int: ...

    def __eq__(self, other: MRZTxSectorsContainer) -> bool: ...

    def copy(self) -> MRZTxSectorsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> MRZTxSectorsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> MRZTxSectorsContainer: ...
...
class MWCRxBeamData:
    ...
    def get_sample_amplitudes_in_db(self, db_offset: float = 0.0) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def set_sample_amplitudes_05dB(self, sample_amplitudes: Annotated[NDArray[numpy.int8], dict(order='C')]) -> None: ...

    def get_sample_amplitudes_05dB(self) -> object: ...

    def set_rx_beam_phase(self, rx_beam_phase: Annotated[NDArray[numpy.int8], dict(order='C')]) -> None: ...
    ...
    def sample_amplitudes_05dB(self) -> Annotated[NDArray[numpy.int8], dict(order='C')]: ...
...
class MWCRxBeamDataContainer:
    ...
    def get_beam_pointing_angle_re_vertical_deg_tensor(self) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_start_range_sample_number_tensor(self) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_detected_range_in_samples_tensor(self) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_transmit_sector_number_tensor(self) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_number_of_samples_tensor(self) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_detected_range_in_samples_high_resolution_tensor(self) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...
...
class MWCTxSectorsContainer:
    ...
    def get_tx_sectors(self) -> list[MWCSectorInfo]: ...

    def set_tx_sectors(self, tx_sectors: Sequence[MWCSectorInfo]) -> None: ...

    def get_tilt_angle_re_tx_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_centre_frequency_hz_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tx_beam_width_along_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_tx_sector_number_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_padding_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def get_number_of_tx_sectors(self) -> int: ...

    def __eq__(self, other: MWCTxSectorsContainer) -> bool: ...

    def copy(self) -> MWCTxSectorsContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> MWCTxSectorsContainer: ...

    def __deepcopy__(self, arg: dict, /) -> MWCTxSectorsContainer: ...
...
class SKMSamplesContainer:
    """Container for SKMSample with vectorized tensor access"""

    def __init__(self) -> None: ...

    @property
    def sensor_data(self) -> list[SKMSample]: ...

    @sensor_data.setter
    def sensor_data(self, arg: Sequence[SKMSample], /) -> None: ...

    def get_sensor_data(self) -> list[SKMSample]: ...

    def set_sensor_data(self, data: Sequence[SKMSample]) -> None: ...

    def get_indices_sorted_by_sensor_timestamp(self, indices: Sequence[int] = []) -> list[int]: ...

    def get_datagram_identifier_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint32], dict(order='C')]: ...

    def get_bytes_content_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_dgm_version_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint16], dict(order='C')]: ...

    def get_time_sec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint32], dict(order='C')]: ...

    def get_time_nanosec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint32], dict(order='C')]: ...

    def get_status_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint32], dict(order='C')]: ...

    def get_latitude_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_longitude_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_ellipsoid_height_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_roll_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_pitch_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_heading_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_heave_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_roll_rate_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_pitch_rate_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_yaw_rate_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_vel_north_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_vel_east_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_vel_down_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_latitude_error_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_longitude_error_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_ellipsoid_height_error_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_roll_error_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_pitch_error_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_heading_error_deg_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_heave_error_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_north_acceleration_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_east_acceleration_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_down_acceleration_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_delayed_heave_time_sec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint32], dict(order='C')]: ...

    def get_delayed_heave_time_nanosec_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint32], dict(order='C')]: ...

    def get_delayed_heave_m_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def get_sensor_timestamp_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_horizontal_position_and_velocity_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_roll_and_pitch_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_heading_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_heave_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_acceleration_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_delayed_heave1_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_delayed_heave2_valid_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_horizontal_position_and_velocity_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_roll_and_pitch_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_heading_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_heave_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_acceleration_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_delayed_heave1_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_delayed_heave2_reduced_performance_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.uint8], dict(order='C')]: ...

    def get_delayed_heave_timestamp_tensor(self, indices: Sequence[int] = []) -> Annotated[NDArray[numpy.float64], dict(order='C')]: ...

    def get_number_of_samples(self) -> int: ...

    def __eq__(self, other: SKMSamplesContainer) -> bool: ...

    def copy(self) -> SKMSamplesContainer:
        """return a copy using the c++ default copy constructor"""

    def __copy__(self) -> SKMSamplesContainer: ...

    def __deepcopy__(self, arg: dict, /) -> SKMSamplesContainer: ...
...
class SKMBinary(KMALLDatagram):
    ...
    def get_sensor_data(self) -> SKMSamplesContainer: ...

    @property
    def sensor_data(self) -> SKMSamplesContainer: ...
...
class MRangeAndDepth(KMALLMultibeamDatagram):
    ...
    @property
    def tx_sectors(self) -> MRZTxSectorsContainer: ...

    @tx_sectors.setter
    def tx_sectors(self, arg: MRZTxSectorsContainer, /) -> None: ...

    @property
    def extra_det_class_info(self) -> MRZExtraDetClassInfoContainer: ...

    @extra_det_class_info.setter
    def extra_det_class_info(self, arg: MRZExtraDetClassInfoContainer, /) -> None: ...
    ...
    def get_seabed_image_samples_dezi_db(self) -> Annotated[NDArray[numpy.int16], dict(order='C')]: ...

    def set_seabed_image_samples_dezi_db(self, samples: Annotated[NDArray[numpy.int16], dict(order='C')]) -> None: ...

    def get_seabed_image_samples_db(self) -> Annotated[NDArray[numpy.float32], dict(order='C')]: ...

    def set_seabed_image_samples_db(self, samples: Annotated[NDArray[numpy.float32], dict(order='C')]) -> None: ...
...
class MWaterColumn(KMALLMultibeamDatagram):
    ...
    @property
    def tx_sectors(self) -> MWCTxSectorsContainer: ...

    @tx_sectors.setter
    def tx_sectors(self, arg: MWCTxSectorsContainer, /) -> None: ...
