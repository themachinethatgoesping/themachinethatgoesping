...
class KongsbergAllPingFileData(themachinethatgoesping.echosounders_nanopy.filetemplates.I_PingFileData):
    ...
    def datagrams_raw(self) -> typing.Any:
        ...
        """
    def get_multisector_calibration(self) -> themachinethatgoesping.echosounders_nanopy.filetemplates.KongsbergAllMultiSectorWaterColumnCalibration:
        ...
    ...
    def get_watercolumn_calibration(self, tx_sector: int) -> KongsbergAllWaterColumnCalibration:
        """
        get_watercolumn_calibration(self) -> themachinethatgoesping.echosounders_nanopy.kongsbergall.filetypes.KongsbergAllWaterColumnCalibration
        """
    ...
    def read_xyz(self) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1:
        """
        read_xyz(self, selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1
        
        Overloaded function.
        
        1. ``read_xyz(self) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1``
        ...
        2. ``read_xyz(self, selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSelection) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1``
    ...
    def release_wci(self) -> None:
        ...
    def set_multisector_calibration(self, calibration: themachinethatgoesping.echosounders_nanopy.filetemplates.KongsbergAllMultiSectorWaterColumnCalibration) -> None:
        ...
    ...
    def set_watercolumn_calibration(self, calibration: KongsbergAllWaterColumnCalibration) -> None:
        """
        set_watercolumn_calibration(self, calibrations: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.kongsbergall.filetypes.KongsbergAllWaterColumnCalibration]) -> None
        """
...
class KongsbergAllPingWatercolumn(themachinethatgoesping.echosounders_nanopy.filetemplates.I_PingWatercolumn):
    ...
    def copy(self) -> KongsbergAllPingWatercolumn:
        ...
        return a copy using the c++ default copy constructor
        """
    def get_multisectorwatercolumn_calibration(self) -> themachinethatgoesping.echosounders_nanopy.filetemplates.KongsbergAllMultiSectorWaterColumnCalibration:
        ...
    def get_raw_amplitudes(self) -> numpy.ndarray[dtype=int8, ..., order='C']:
        """
        get_raw_amplitudes(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection) -> numpy.ndarray[dtype=int8, shape=(*, *), order='C']
        """
    def get_raw_amplitudes_float(self) -> numpy.ndarray[dtype=float32, ..., order='C']:
        """
        get_raw_amplitudes_float(self, beam_selection: themachinethatgoesping.echosounders_nanopy.pingtools.BeamSampleSelection) -> numpy.ndarray[dtype=float32, shape=(*, *), order='C']
        """
