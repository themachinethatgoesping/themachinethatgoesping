...
__all__: list[str] = ['AttitudeDatagram', 'ClockDatagram', 'DepthOrHeightDatagram', 'ExtraDetections', 'ExtraParameters', 'ExtraParameters_t_ContentIdentifier', 'HeadingDatagram', 'InstallationParameters', 'KongsbergAllDatagram', 'KongsbergAllUnknown', 'NetworkAttitudeVelocityDatagram', 'PUIDOutput', 'PUStatusOutput', 'PositionDatagram', 'QualityFactorDatagram', 'RawRangeAndAngle', 'RuntimeParameters', 'SeabedImageData', 'SingleBeamEchoSounderDepth', 'SoundSpeedProfileDatagram', 'SurfaceSoundSpeedDatagram', 'WatercolumnDatagram', 'XYZDatagram', 'o_ExtraParameters_t_ContentIdentifier', 'substructures']
class AttitudeDatagram(KongsbergAllDatagram):
    ...
    def set_attitude_counter(self, arg: int) -> None:
        ...
    def set_attitudes(self, arg: collections.abc.Sequence[substructures.AttitudeDatagramAttitude]) -> None:
        """
        < N x Attitude data
        """
...
class ExtraDetections(KongsbergAllDatagram):
    ...
    def set_depth_of_reference_point(self, arg: float) -> None:
        ...
        < m
        """
    def set_detection_classes(self, arg: collections.abc.Sequence[substructures.ExtraDetectionsDetectionClasses]) -> None:
        """
        < substructure 1
        """
    def set_etx(self, arg: int) -> None:
        ...
        < end identifier (always 0x03)
        """
    def set_extra_detections(self, arg: collections.abc.Sequence[substructures.ExtraDetectionsExtraDetections]) -> None:
        """
        < substructure 2
        """
...
class ExtraParameters_t_ContentIdentifier(enum.Enum):
    """
    """
    Bscorr: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.Bscorr
    CalibTxt: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.CalibTxt
    LogAllHeights: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.LogAllHeights
    MultiCastInputStatus: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.MultiCastInputStatus
    SoundVelocityAtTransducer: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.SoundVelocityAtTransducer
    SoundVelocityProfile: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.SoundVelocityProfile
class HeadingDatagram(KongsbergAllDatagram):
    ...
    def get_heading_indicator(self) -> int:
        ...
        < 0 = inactive
        """
    def get_heading_timestamps(self) -> numpy.ndarray[dtype=float64, ..., order='C']:
        """
        ...
        """
    def get_headings_in_degrees(self) -> numpy.ndarray[dtype=float32, ..., order='C']:
        """
    ...
    def get_system_serial_number(self) -> int:
        ...
    def get_times_and_headings(self) -> numpy.ndarray[dtype=uint16, ..., order='C']:
        """
    ...
    def set_system_serial_number(self, arg: int) -> None:
        ...
    def set_times_and_headings(self, arg: numpy.ndarray[dtype=uint16, ..., order='C']) -> None:
        """
        < 2xN array of time in ms since record start and heading in 0.01°
        """
    def times_and_headings(self) -> numpy.ndarray[dtype=uint16, ..., order='C']:
        """
        < 2xN array of time in ms since record start and heading in 0.01°
        """
    def to_binary(self, resize_buffer: bool = True) -> bytes:
...
class InstallationParameters(KongsbergAllDatagram):
    ...
    """
    from_binary: typing.ClassVar[nanobind.nb_func]  # value = <nanobind.nb_func object>
    merge: typing.ClassVar[nanobind.nb_func]  # value = <nanobind.nb_func object>
    @staticmethod
    def __new__(type, *args, **kwargs):
        """
        Create and return a new object.  See help(type) for accurate signature.
    ...
    def get_attitude_sensor_offsets(self, sensor_number: themachinethatgoesping.echosounders_nanopy.o_KongsbergAllActiveSensor) -> themachinethatgoesping.navigation_nanopy.datastructures.PositionalOffsets:
        """
        get_attitude_sensor_offsets(self, sensor: int) -> themachinethatgoesping.navigation_nanopy.datastructures.PositionalOffsets
...
class NetworkAttitudeVelocityDatagram(KongsbergAllDatagram):
    ...
    def print(self, float_precision: int = 3, superscript_exponents: bool = True) -> None:
        ...
        Print object information
        """
    def set_attitudes(self, arg: collections.abc.Sequence[substructures.NetworkAttitudeVelocityDatagramAttitude]) -> None:
        """
        < N x Attitude data
        """
    def set_checksum(self, arg: int) -> None:
...
class PUIDOutput(KongsbergAllDatagram):
    ...
    def __new__(type, *args, **kwargs):
        ...
        """
    @staticmethod
    def set_host_ip_address(*args, **kwargs) -> None:
        ...
    @staticmethod
    def set_spare(*args, **kwargs) -> None:
        ...
...
class QualityFactorDatagram(KongsbergAllDatagram):
    ...
    def get_ping_counter(self) -> int:
        ...
        """
    def get_quality_factors(self) -> numpy.ndarray[dtype=float32, ..., order='C']:
        """
    ...
    def qf_shape(self) -> ...:
        ...
        """
    def quality_factors(self) -> numpy.ndarray[dtype=float32, ..., order='C']:
        """
        < dimension is [Nrx, Npar]
        """
    def set_checksum(self, arg: int) -> None:
    ...
    def set_ping_counter(self, arg: int) -> None:
        ...
        < 0-65535 ping number (in this file)
        """
    def set_quality_factors(self, arg: numpy.ndarray[dtype=float32, ..., order='C']) -> None:
        """
        < dimension is [Nrx, Npar]
        """
    def set_spare(self, arg: int) -> None:
...
class RawRangeAndAngle(KongsbergAllDatagram):
    ...
    def get_beam_crosstrack_angles(self) -> ...:
        """
        get_beam_crosstrack_angles(self, beam_numbers: collections.abc.Sequence[int]) -> xt::xtensor_container<xt::uvector<float, xsimd::aligned_allocator<float, 16ul> >, 1ul, (xt::layout_type)1, xt::xtensor_expression_tag>
        
        Overloaded function.
        
        1. ``get_beam_crosstrack_angles(self) -> xt::xtensor_container<xt::uvector<float, xsimd::aligned_allocator<float, 16ul> >, 1ul, (xt::layout_type)1, xt::xtensor_expression_tag>``
        ...
        2. ``get_beam_crosstrack_angles(self, beam_numbers: collections.abc.Sequence[int]) -> xt::xtensor_container<xt::uvector<float, xsimd::aligned_allocator<float, 16ul> >, 1ul, (xt::layout_type)1, xt::xtensor_expression_tag>``
    ...
    def get_two_way_travel_times(self) -> ...:
        """
        get_two_way_travel_times(self, beam_numbers: collections.abc.Sequence[int]) -> xt::xtensor_container<xt::uvector<float, xsimd::aligned_allocator<float, 16ul> >, 1ul, (xt::layout_type)1, xt::xtensor_expression_tag>
        
        Overloaded function.
        
        1. ``get_two_way_travel_times(self) -> xt::xtensor_container<xt::uvector<float, xsimd::aligned_allocator<float, 16ul> >, 1ul, (xt::layout_type)1, xt::xtensor_expression_tag>``
        ...
        2. ``get_two_way_travel_times(self, beam_numbers: collections.abc.Sequence[int]) -> xt::xtensor_container<xt::uvector<float, xsimd::aligned_allocator<float, 16ul> >, 1ul, (xt::layout_type)1, xt::xtensor_expression_tag>``
    ...
    def print(self, float_precision: int = 3, superscript_exponents: bool = True) -> None:
        ...
        Print object information
        """
    def set_beams(self, arg: collections.abc.Sequence[substructures.RawRangeAndAngleBeam]) -> None:
        ...
    def set_checksum(self, arg: int) -> None:
        ...
    ...
    def set_system_serial_number(self, arg: int) -> None:
        ...
    def set_transmit_sectors(self, arg: collections.abc.Sequence[substructures.RawRangeAndAngleTransmitSector]) -> None:
        ...
    def to_binary(self, resize_buffer: bool = True) -> bytes:
        """
        convert object to bytearray
...
class RuntimeParameters(KongsbergAllDatagram):
    ...
    def get_sonar_mode_enabled(self) -> bool:
        """
        get_sonar_mode_enabled(self) -> bool
...
class SeabedImageData(KongsbergAllDatagram):
    ...
    def sample_amplitudes(self) -> substructures.SampleAmplitudesStructure_int16_t:
        ...
        < in 0.1 dB (size = sum of _Number_of_samples of all Beams
        """
    def set_beams(self, arg: collections.abc.Sequence[substructures.SeabedImageDataBeam]) -> None:
        ...
    def set_checksum(self, arg: int) -> None:
        ...
    def set_etx(self, arg: int) -> None:
...
class SoundSpeedProfileDatagram(KongsbergAllDatagram):
    ...
    def copy(self) -> SoundSpeedProfileDatagram:
        ...
        return a copy using the c++ default copy constructor
        """
    def depths_and_sound_speeds(self) -> numpy.ndarray[dtype=uint32, ..., order='C']:
        """
    ...
    def get_depth_resolution_in_meters(self) -> float:
        ...
        """
    def get_depths_and_sound_speeds(self) -> numpy.ndarray[dtype=uint32, ..., order='C']:
        """
        < 2xN array of depth in cm and sound speed in dm/s
        """
    def get_depths_in_meters(self) -> numpy.ndarray[dtype=float64, ..., order='C']:
        """
    ...
    def get_profile_timestamp(self) -> float:
        ...
        Returns:
            unixtime as double
        """
    def get_sound_speeds_in_meters_per_second(self) -> numpy.ndarray[dtype=float32, ..., order='C']:
        """
    ...
    def set_depth_resolution(self, arg: int) -> None:
        ...
        < in cm
        """
    def set_depths_and_sound_speeds(self, arg: numpy.ndarray[dtype=uint32, ..., order='C']) -> None:
        """
        < 2xN array of depth in cm and sound speed in dm/s
        """
    def set_etx(self, arg: int) -> None:
...
class SurfaceSoundSpeedDatagram(KongsbergAllDatagram):
    ...
    def get_sound_speed_counter(self) -> int:
        ...
        < Sequential Number
        """
    def get_sound_speed_timestamps(self) -> numpy.ndarray[dtype=float64, ..., order='C']:
        """
        return the times converted to unix timestamps
    ...
    def get_system_serial_number(self) -> int:
        ...
    def get_times_and_sound_speeds(self) -> numpy.ndarray[dtype=uint16, ..., order='C']:
        """
    ...
    def set_system_serial_number(self, arg: int) -> None:
        ...
    def set_times_and_sound_speeds(self, arg: numpy.ndarray[dtype=uint16, ..., order='C']) -> None:
        """
        < 2xN array of time in ms since record < start and sound_speed in dm/s
        """
    def times_and_sound_speeds(self) -> numpy.ndarray[dtype=uint16, ..., order='C']:
        """
        < 2xN array of time in ms since record < start and sound_speed in dm/s
        """
    def to_binary(self, resize_buffer: bool = True) -> bytes:
...
class WatercolumnDatagram(KongsbergAllDatagram):
    ...
    def get_ping_counter(self) -> int:
        ...
    def get_samples(self) -> numpy.ndarray[dtype=float32, ..., order='C']:
        ...
    ...
    def print(self, float_precision: int = 3, superscript_exponents: bool = True) -> None:
        ...
        Print object information
        """
    def set_beams(self, arg: collections.abc.Sequence[substructures.WatercolumnDatagramBeam]) -> None:
        ...
    def set_checksum(self, arg: int) -> None:
        ...
    ...
    def set_total_no_of_receive_beams(self, arg: int) -> None:
        ...
    def set_transmit_sectors(self, arg: collections.abc.Sequence[substructures.WatercolumnDatagramTransmitSector]) -> None:
        ...
...
class XYZDatagram(KongsbergAllDatagram):
    ...
    def __new__(type, *args, **kwargs):
        ...
        """
    @staticmethod
    def set_spare_bytes(*args, **kwargs) -> None:
        ...
    ...
    def get_xyz(self) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1:
        """
        get_xyz(self, beam_numbers: collections.abc.Sequence[int]) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1
        ...
        2. ``get_xyz(self, beam_numbers: collections.abc.Sequence[int]) -> themachinethatgoesping.algorithms_nanopy.geoprocessing.datastructures.XYZ_1``
    ...
    def print(self, float_precision: int = 3, superscript_exponents: bool = True) -> None:
        ...
        Print object information
        """
    def set_beams(self, arg: collections.abc.Sequence[substructures.XYZDatagramBeam]) -> None:
        """
        < beam detection information
        """
    def set_checksum(self, arg: int) -> None:
...
class o_ExtraParameters_t_ContentIdentifier:
    ...
    """
    __default_value__: typing.ClassVar[ExtraParameters_t_ContentIdentifier]  # value = ExtraParameters_t_ContentIdentifier.CalibTxt
    from_binary: typing.ClassVar[nanobind.nb_func]  # value = <nanobind.nb_func object>
    @staticmethod
    def __new__(type, *args, **kwargs):
        """
    ...
    def __eq__(self, arg: o_ExtraParameters_t_ContentIdentifier) -> bool:
        """
        __eq__(self, arg: themachinethatgoesping.echosounders_nanopy.kongsbergall.datagrams.ExtraParameters_t_ContentIdentifier, /) -> bool
    ...
    def __hash__(self) -> int:
        ...
        hash function implemented using binary_hash
        """
    def __init__(self, value: ExtraParameters_t_ContentIdentifier = ...) -> None:
        """
        ...
        1. ``__init__(self, value: themachinethatgoesping.echosounders_nanopy.kongsbergall.datagrams.ExtraParameters_t_ContentIdentifier = ExtraParameters_t_ContentIdentifier.CalibTxt) -> None``
