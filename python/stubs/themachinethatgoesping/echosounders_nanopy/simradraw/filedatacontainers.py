...
class SimradRawDatagramContainer_FIL1:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_FIL1:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_FIL1
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.FIL1:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_FIL1
        """
...
class SimradRawDatagramContainer_FIL1_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_FIL1_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_FIL1_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.FIL1:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_FIL1_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Header:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Header:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Header
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawDatagram:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Header
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Header_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Header_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Header_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawDatagram:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Header_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_MRU0:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_MRU0:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_MRU0
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.MRU0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_MRU0
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_MRU0_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_MRU0_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_MRU0_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.MRU0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_MRU0_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_NME0:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_NME0:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_NME0
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.NME0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_NME0
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_NME0_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_NME0_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_NME0_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.NME0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_NME0_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_RAW3:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_RAW3:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_RAW3_skipped_data:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_RAW3_skipped_data:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3_skipped_data
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3_skipped_data
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_RAW3_skipped_data_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_RAW3_skipped_data_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3_skipped_data_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3_skipped_data_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_RAW3_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_RAW3_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_RAW3_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_TAG0:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_TAG0:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_TAG0
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.TAG0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_TAG0
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_TAG0_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_TAG0_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_TAG0_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.TAG0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_TAG0_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Unknown:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Unknown:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Unknown
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawUnknown:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Unknown
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Unknown_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Unknown_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Unknown_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawUnknown:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Unknown_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Variant:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Variant:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawDatagram | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.NME0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.MRU0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.FIL1 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.TAG0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawUnknown:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Variant_skipped_data:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Variant_skipped_data:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant_skipped_data
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawDatagram | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.NME0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.MRU0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.FIL1 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.TAG0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawUnknown:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant_skipped_data
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Variant_skipped_data_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Variant_skipped_data_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant_skipped_data_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawDatagram | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.NME0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.MRU0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.FIL1 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.TAG0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawUnknown:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant_skipped_data_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_Variant_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_Variant_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawDatagram | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.NME0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.MRU0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.RAW3 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.FIL1 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.TAG0 | themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.SimradRawUnknown:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_Variant_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_XML0:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_XML0:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_XML0
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_XML0
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawDatagramContainer_XML0_stream:
    ...
    def __call__(self, datagram_identifier: themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier) -> SimradRawDatagramContainer_XML0_stream:
        """
        __call__(self, datagram_identifiers: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.t_SimradRawDatagramIdentifier]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_XML0_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawDatagramContainer_XML0_stream
        """
    def __len__(self) -> int:
        ...
    def __repr__(self) -> str:
...
class SimradRawPingContainer:
    ...
    def __call__(self, channel_id: str) -> SimradRawPingContainer:
        """
        __call__(self, channel_ids: collections.abc.Sequence[str]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawPingContainer
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatatypes.SimradRawPing:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawPingContainer
        """
    def __init__(self) -> None:
        """
        __init__(self, arg: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.filedatatypes.SimradRawPing], /) -> None
...
class SimradRawPingContainer_stream:
    ...
    def __call__(self, channel_id: str) -> SimradRawPingContainer_stream:
        """
        __call__(self, channel_ids: collections.abc.Sequence[str]) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawPingContainer_stream
        """
    ...
    def __getitem__(self, index: int) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatatypes.SimradRawPing_stream:
        """
        __getitem__(self, slice: themachinethatgoesping.tools_nanopy.pyhelper.PyIndexerSlice) -> themachinethatgoesping.echosounders_nanopy.simradraw.filedatacontainers.SimradRawPingContainer_stream
        """
    def __init__(self) -> None:
        """
        __init__(self, arg: collections.abc.Sequence[themachinethatgoesping.echosounders_nanopy.simradraw.filedatatypes.SimradRawPing_stream], /) -> None
