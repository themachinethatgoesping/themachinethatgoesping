...
class SimradRawWaterColumnCalibration(themachinethatgoesping.echosounders_nanopy.filetemplates.WaterColumnCalibration):
    ...
    def __init__(self) -> None:
        """
        __init__(self, other: themachinethatgoesping.echosounders_nanopy.filetemplates.WaterColumnCalibration) -> None
        __init__(self, environment: themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0_datagrams.XML_Environment, parameters: themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0_datagrams.XML_Parameter_Channel, transceiver_information: themachinethatgoesping.echosounders_nanopy.simradraw.filedatatypes.TransceiverInformation, filter_stages: std::pair<themachinethatgoesping::echosounders::simradraw::datagrams::FIL1, themachinethatgoesping::echosounders::simradraw::datagrams::FIL1>, n_complex_samples: int) -> None
        """
    ...
    def compute_effective_pulse_duration_s(self, round_to_full_samples: bool = True, start_phase_degrees: float = 0.0) -> float:
        ...
        Returns:
            float
        """
    def compute_filtered_transmit_pulse(self, start_phase_degrees: float = 0.0) -> ...:
        """
    ...
    def compute_internal_sampling_interval_hz(self) -> float:
        ...
        Returns:
            float
        """
    def compute_raw_transmit_pulse(self, start_phase_degrees: float = 0.0) -> ...:
        """
    ...
    def get_equivalent_beam_angle_db(self) -> float:
        ...
    def get_filter_stage_1_coefficients(self) -> numpy.ndarray[dtype=complex64, ..., order='C']:
        ...
    def get_filter_stage_1_decimation_factor(self) -> int:
        ...
    def get_filter_stage_2_coefficients(self) -> numpy.ndarray[dtype=complex64, ..., order='C']:
        ...
    ...
    def set_environment_parameters(self, environment: themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0_datagrams.XML_Environment) -> None:
        """
        set_environment_parameters(self, reference_depth_m: float, temperature_c: float, salinity_psu: float, acidity_ph: float = 8.0600004196167) -> None
        set_environment_parameters(self, forced_sound_velocity_m_s: float, forced_absorption_db_m: float) -> None
        """
    def set_filter_parameters(self, filter_stages: ..., themachinethatgoesping: ...) -> None:
        """
        set_filter_parameters(self, stage1_decimation_factor: int, stage1_coefficients: numpy.ndarray[dtype=complex64, shape=(*), order='A'], stage2_decimation_factor: int, stage2_coefficients: numpy.ndarray[dtype=complex64, shape=(*), order='A']) -> None
        """
    ...
    def set_runtime_parameters(self, parameters: themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0_datagrams.XML_Parameter_Channel) -> None:
        """
        set_runtime_parameters(self, frequency_hz: float, transmit_power_w: float, nominal_pulse_duration_s: float, slope: float, sample_interval_s: float) -> None
        """
    def set_transducer_parameters(self, transducer: themachinethatgoesping.echosounders_nanopy.simradraw.datagrams.XML0_datagrams.XMLConfigurationTransceiverChannelTransducer, pulse_duration_index: int) -> None:
        """
        set_transducer_parameters(self, transducer_gain_db: float, sa_correction_db: float, equivalent_beam_angle_db: float, frequency_nominal_hz: float) -> None
        """
