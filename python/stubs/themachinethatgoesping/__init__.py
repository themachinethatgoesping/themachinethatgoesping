...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.29.1'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.9.4'), ('navigation', '0.17.7'), ('echosounders_cppy', '0.45.4'), ('echosounders', '0.45.4'), ('pingprocessing_cppy', '0.11.5'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
