...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.28.6'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.9.2'), ('navigation', '0.17.4'), ('echosounders_cppy', '0.45.1'), ('echosounders', '0.45.1'), ('pingprocessing_cppy', '0.11.3'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
