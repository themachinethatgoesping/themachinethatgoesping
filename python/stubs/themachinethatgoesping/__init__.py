...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.21.9'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.5.7'), ('navigation', '0.15.0'), ('echosounders_cppy', '0.34.0'), ('echosounders', '0.34.0'), ('pingprocessing_cppy', '0.5.1'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
