...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.24.0'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.8.0'), ('navigation', '0.16.0'), ('echosounders_cppy', '0.38.2'), ('echosounders', '0.38.2'), ('pingprocessing_cppy', '0.8.0'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
