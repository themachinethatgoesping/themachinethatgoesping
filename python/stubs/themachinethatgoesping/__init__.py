...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.28.8'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.9.3'), ('navigation', '0.17.4'), ('echosounders_cppy', '0.45.1'), ('echosounders', '0.45.1'), ('pingprocessing_cppy', '0.11.3'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
