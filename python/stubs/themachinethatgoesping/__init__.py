...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.23.0'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.6.0'), ('navigation', '0.15.3'), ('echosounders_cppy', '0.37.2'), ('echosounders', '0.37.2'), ('pingprocessing_cppy', '0.5.6'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
