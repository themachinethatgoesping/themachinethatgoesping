...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.22.0'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.5.7'), ('navigation', '0.15.0'), ('echosounders_cppy', '0.34.1'), ('echosounders', '0.34.1'), ('pingprocessing_cppy', '0.5.2'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
