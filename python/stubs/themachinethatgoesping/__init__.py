...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.22.3'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.6.0'), ('navigation', '0.15.1'), ('echosounders_cppy', '0.37.0'), ('echosounders', '0.37.0'), ('pingprocessing_cppy', '0.5.3'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
