...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.22.4'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.6.0'), ('navigation', '0.15.2'), ('echosounders_cppy', '0.37.1'), ('echosounders', '0.37.1'), ('pingprocessing_cppy', '0.5.5'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
