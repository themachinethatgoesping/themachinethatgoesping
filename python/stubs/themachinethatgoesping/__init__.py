...
def version():
    ...
__modules_installed__: list = [('tools_cppy', '0.22.2'), ('tools', '@PROJECT_VERSION@'), ('scripts', '@PROJECT_VERSION@'), ('algorithms', '0.5.9'), ('navigation', '0.15.1'), ('echosounders_cppy', '0.36.1'), ('echosounders', '0.36.1'), ('pingprocessing_cppy', '0.5.3'), ('pingprocessing', '@PROJECT_VERSION@'), ('gridding', '@PROJECT_VERSION@')]
__submodule: str = '../'
