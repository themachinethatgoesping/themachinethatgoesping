...
class FileSimradRaw:
    ...
    def __init__(self, file_path: str, cached_index: dict[str, filetypes.FileInfoData_simrad_FileInfoData] = {}, init: bool = True, show_progress: bool = True) -> None:
        ...
    @typing.overload
    def __init__(self, file_path: str, cached_index: dict[str, filetypes.FileInfoData_simrad_FileInfoData], init: bool, progress_bar: themachinethatgoesping.tools_cppy.progressbars.I_ProgressBar) -> None:
        ...
    @typing.overload
    def __init__(self, file_path: list[str], cached_index: dict[str, filetypes.FileInfoData_simrad_FileInfoData] = {}, init: bool = True, show_progress: bool = True) -> None:
        ...
    @typing.overload
    def __init__(self, file_paths: list[str], cached_index: dict[str, filetypes.FileInfoData_simrad_FileInfoData], init: bool, progress_bar: themachinethatgoesping.tools_cppy.progressbars.I_ProgressBar) -> None:
        ...
