...
class FileRaw():
    ...
    def __getitem__(self, index: int) -> typing.Union[datagrams.EK60_Datagram, datagrams.EK80_MRU0, datagrams.EK80_XML0, datagrams.EK60_NME0, datagrams.EK60_Unknown]: ...
    @typing.overload
