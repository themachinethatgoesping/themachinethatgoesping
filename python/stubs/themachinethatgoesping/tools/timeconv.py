...
def datestring_to_unixtime(unixtime: str, format: str = ...) -> float:
    """
    ...
    """
def unixtime_to_datestring(unixtime: float, fractionalSecondsDigits: int = ..., format: str = ...) -> str:
    """
    Converting between date strings and unixtime stamps (ref 1970)
    ...
    """
def year_month_day_to_unixtime(year: int, month: int, day: int, micro_seconds: int = ...) -> float:
    """
