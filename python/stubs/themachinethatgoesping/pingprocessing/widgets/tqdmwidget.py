...
class TqdmWidget(ipywidgets.widgets.widget_box.HBox):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('children', 'kwargs', 'list_like', 'progress', 'progress_iter')
    _all_trait_default_generators: typing.ClassVar[dict]  # value = {'_dom_classes': traitlets.traitlets.TraitType.default, '_model_module': traitlets.traitlets.TraitType.default, '_model_module_version': traitlets.traitlets.TraitType.default, '_model_name': traitlets.traitlets.TraitType.default, '_msg_callbacks': traitlets.traitlets.TraitType.default, '_property_lock': traitlets.traitlets.TraitType.default, '_states_to_send': traitlets.traitlets.TraitType.default, '_view_count': traitlets.traitlets.TraitType.default, '_view_module': traitlets.traitlets.TraitType.default, '_view_module_version': traitlets.traitlets.TraitType.default, '_view_name': traitlets.traitlets.TraitType.default, 'box_style': traitlets.traitlets.TraitType.default, 'children': traitlets.traitlets.TraitType.default, 'comm': traitlets.traitlets.TraitType.default, 'keys': <traitlets.traitlets.DefaultHandler object>, 'layout': traitlets.traitlets.TraitType.default, 'log': <traitlets.traitlets.DefaultHandler object>, 'tabbable': traitlets.traitlets.TraitType.default, 'tooltip': traitlets.traitlets.TraitType.default}
