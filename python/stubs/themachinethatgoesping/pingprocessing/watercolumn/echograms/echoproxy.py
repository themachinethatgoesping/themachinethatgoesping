...
class EchoProxy:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('beam_sample_selections', 'depth_to_y_coordinate_interpolator', 'has_depths', 'has_ranges', 'indice_to_x_coordinate_interpolator', 'initialized', 'linear_mean', 'max_depths', 'max_ranges', 'max_sample_numbers', 'min_depths', 'min_ranges', 'param', 'ping_numbers', 'ping_times', 'pings', 'range_to_y_coordinate_interpolator', 'res_depths', 'res_ranges', 'sample_nr_to_depth_interpolator', 'sample_nr_to_range_interpolator', 'sample_nr_to_y_coordinate_interpolator', 'time_zone', 'vec_max_y', 'vec_min_y', 'vec_x_val', 'wci_value', 'x_axis_function', 'x_axis_name', 'x_coordinate_indice_interpolator', 'x_coordinates', 'x_extent', 'x_interpolation_limit', 'x_kwargs', 'x_resolution', 'y_axis_function', 'y_axis_name', 'y_coordinate_indice_interpolator', 'y_coordinates', 'y_extent', 'y_kwargs', 'y_resolution')
    @staticmethod
