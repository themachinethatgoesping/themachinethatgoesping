...
@overload
def utm_to_latlon(northing: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], easting: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], zone: int, northern_hemisphere: bool, mp_cores: int = 1) -> tuple[Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]]:
    """
...
@overload
def utm_to_latlon(northing: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], easting: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], zone: Annotated[NDArray[numpy.int32], dict(shape=(None,), order='A')], northern_hemisphere: Annotated[NDArray[numpy.int32], dict(shape=(None,), order='A')], mp_cores: int = 1) -> tuple[Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]]: ...

def latlon_to_utm(latitude: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], longitude: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], setzone: int = -1, mp_cores: int = 1) -> tuple[Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], int, bool]: ...
...
@overload
def compute_latlon_distances_m(latitudes: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], longitudes: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]:
    """
...
@overload
def compute_latlon_distances_m(latitudes: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], longitudes: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def compute_latlon_distances_m(geolocations_latlon: Sequence[themachinethatgoesping.navigation_nanopy.datastructures.GeolocationLatLon]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def compute_latlon_distances_m(geolocations_latlon: Sequence[themachinethatgoesping.navigation_nanopy.datastructures.SensordataLatLon]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def compute_latlon_distances_m(geolocations_latlon: Sequence[tuple[float, float]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def compute_latlon_distances_m(geolocations_latlon: Sequence[tuple[float, float]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def cumulative_latlon_distances_m(latitudes: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')], longitudes: Annotated[NDArray[numpy.float32], dict(shape=(None,), order='A')]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]:
    """
...
@overload
def cumulative_latlon_distances_m(latitudes: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')], longitudes: Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def cumulative_latlon_distances_m(geolocations_latlon: Sequence[themachinethatgoesping.navigation_nanopy.datastructures.GeolocationLatLon]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def cumulative_latlon_distances_m(geolocations_latlon: Sequence[themachinethatgoesping.navigation_nanopy.datastructures.SensordataLatLon]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...

@overload
def cumulative_latlon_distances_m(geolocations_latlon: Sequence[tuple[float, float]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='A')]: ...
