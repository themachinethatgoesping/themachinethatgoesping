...
class NMEA_Base:
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_Base: ...
...
class NMEA_ZDA(NMEA_Base):
    """
    The NMEA ZDA datagram contains the universal time code (UTC),
    ...
    def __init__(self, nmea_base: NMEA_Base, check: bool = True) -> None:
        ...
        Args:
            ...
            check: Check if the NMEA string is valid
        """
    ...
    def to_date_string(self, format: str = '%z__%d-%m-%Y__%H:%M:%S') -> str:
        """
        Convert the datagram into a date time string
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_ZDA: ...
...
class NMEA_VLW(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_VLW: ...
...
class NMEA_VTG(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_VTG: ...
...
class NMEA_VHW(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_VHW: ...
...
class NMEA_RMC(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_RMC: ...
...
class NMEA_HDT(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_HDT: ...
...
class NMEA_GLL(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_GLL: ...
...
class NMEA_GGA(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_GGA: ...
...
class NMEA_GST(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_GST: ...
...
class NMEA_Unknown(NMEA_Base):
    ...
    def __deepcopy__(self, arg: dict, /) -> NMEA_Unknown: ...
